  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `outfits` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `imagePath` TEXT NOT NULL, `tags` TEXT NOT NULL)");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '508399e1c6b06f4b503c5da71305124d')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        final HashMap<String, TableInfo.Column> _columnsOutfits = new HashMap<String, TableInfo.Column>(3);
        _columnsOutfits.put("id", new TableInfo.Column("id", "INTEGER", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsOutfits.put("imagePath", new TableInfo.Column("imagePath", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsOutfits.put("tags", new TableInfo.Column("tags", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (!_infoOutfits.equals(_existingOutfits)) {
          return new RoomOpenHelper.ValidationResult(false, "outfits(de.schmelzle.outfitorganizer.data.OutfitEntity).\n"
                  + " Expected:\n" + _infoOutfits + "\n"
                  + " Found:\n" + _existingOutfits);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "508399e1c6b06f4b503c5da71305124d", "329da3b66fcae1c601851da8b4af6b72");
